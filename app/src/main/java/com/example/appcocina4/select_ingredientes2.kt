...
class select_ingredientes2 : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_select_ingredientes2)
        ...
        db.collection("ingredientes").document(NombreI).collection("Ingredientes").get().addOnSuccessListener { doc ->
            ...
            while (j < doc.size()){
                if (j == 0){
                    ...
                    //tempTxtvisible.setTextColor(R.color.Letras_Blancas!!)
                    tempTxtvisible.textSize = 24F
                    tempTxtvisible.setText(NombreI+" :")

                    tempTxtEspacio.textSize = 24F
                ...
                if ( j%2==0 || j == 0){
                    ...
                    if ( j%2!=0 ){
                        tempCheck2.id = j
                        tempCheck2.textSize = 24F
                        //tempCheck2.setTextColor(R.color.Letras_Blancas!!)
